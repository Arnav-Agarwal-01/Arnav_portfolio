    ...
    <div className="relative text-black">
      ...
      <div className="flex items-start justify-start w-full" onMouseEnter={onEnter} onMouseLeave={onLeave} onMouseMove={onMove}>
        <VariableFontHoverByRandomLetter
          ...
          className={`flex flex-wrap justify-start cursor-pointer align-text-top md:-translate-y-38 md:translate-x-5 ${outfit.className} text-[2rem] sm:text-[2.5rem] md:text-[6rem] lg:text-[9rem]`}
