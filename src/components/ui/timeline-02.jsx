...
export default function Timeline_02() {
  return (
    <section className="bg-background py-24">
      <div className="ml-[2rem] md:ml-[4rem] lg:ml-[6rem] mr-8">
        <h1
          className="text-foreground mb-16 text-left text-4xl font-bold tracking-tight sm:text-5xl">
        ...
        <div className="relative max-w-3xl">
          ...
          {timelineData.map((entry, index) => (
            <motion.div
              ...
              {/* Timeline dot */}
              <div
                className="absolute left-2 top-5 h-3 w-3 rounded-full bg-cyan-500 ring-4 ring-background" />
